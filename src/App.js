...
class App extends React.Component {
  ...
  render() {  
    return  ( 
      ...
      >
        <div className="App justify-content-center" style={{padding: '0', margin: '0 auto', maxWidth: '900px'}} >
          <Container fluid='md'>
            <Switch>
              ...
              <Route exact path="/myinfo/loginsetting" component={Auth(LoginSetupPage, true)} /> 
