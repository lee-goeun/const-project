      ...
      <>
        ...
        <div className='wallet-grid-container' style={{margin: '0'}}>
          <div className='wallet-grid'>
            <p style={{ flex: '1'}}>보유 수량</p> <p style={{ flex: '1'}}>0.9352 KLAY</p>
          </div>
          <div className='wallet-grid'>
            <p style={{ flex: '1'}}>매수 평균가</p> <p style={{ flex: '1'}}>₩2,845,000</p>
          </div>
          <div className='wallet-grid'>
            <p style={{ flex: '1'}}>평가 금액</p> <p style={{ flex: '1'}}>₩1,150,000</p>
          </div>
          <div className='wallet-grid'>
            <p style={{ flex: '1'}}>매수 금액</p> <p style={{ flex: '1'}}>₩1,000,000</p>
          </div>
        </div>
      </>
  )
